...
const UserHomePage = () => {
    ...
    const deleteFavorite = (newState: InitialStateType) => {
        dispatch(newState)
    }
                    ...
                    <div className="user-home-content">
                        ...
                        <div className="user-favorite-container">
                            {state.ads.length === 0 ? (
                                <div>
                                    {state.ads.map((ad) => (
                                        <FavoriteRow ad={ad} deleteFavorite={deleteFavorite} state={state} />
                                    ))}
                                </div>
                            ) : (
                                <span>Vous n'avez aucune annonce en favoris</span>
                            )}
